    ...
    <div className="bg-white p-5 rounded-lg shadow hover:shadow-md transition-shadow duration-300 w-full h-full border border-gray-100 dark:border-gray-700">
      ...
      <div className="flex flex-col gap-2 text-sm">
        ...
        <div className="flex gap-2 w-full">
          ...
          <div className="flex items-center space-x-2 p-2 rounded-md bg-blue-50  text-blue-700 dark:text-blue-300 flex-1">
          ...
          <div className="flex items-center space-x-2 p-2 rounded-md bg-green-50  text-green-700 dark:text-green-300 flex-1">
        ...
        <div className="flex gap-2 w-full">
          ...
          <div className="flex items-center space-x-2 p-2 rounded-md bg-yellow-50  text-yellow-700 dark:text-yellow-300 flex-1">
          ...
          <div className="flex items-center space-x-2 p-2 rounded-md bg-red-50  text-red-700 dark:text-red-300 flex-1">
        ...
        <div className="flex items-center space-x-2 p-2 rounded-md bg-gray-100  font-medium text-gray-800 dark:text-white w-full">
